...
- Preserve natural prose claim text in the heading/body
...
Source: [source filename](ops/queue/archive/.../source-filename.md)
...
Write to: `{vocabulary.notes}/[title-as-prose-with-spaces].md`
The filename IS the prose title — lowercase, spaces preserved, same text as the `#` heading. Do not slugify or hyphenate.
...
- {vocabulary.topic_map} notes (sections: Synthesis, Core Ideas, Tensions, Gaps/Open Questions)
...
Source: [source filename](ops/queue/archive/.../source-filename.md) (lines NNN-NNN)
