 ...
 *
 * Uses extractWikiLinkTargets() to parse [[wiki links]] from thought files,
 * then follows them hop-by-hop up to maxDepth (default: 2).
 *
...
import { extractWikiLinkTargets } from "./graph-links.js";
